...
def interview_video_qc(interview_type, data_root, study, ptID):
	...
	output_path_format = "avlqc"+"-"+ptID+"-interviewVideoQC_" + interview_type + "-day*.csv"
	...
	if len(output_paths) == 1:
		...
		# study name in the DPDash CSV name needs to always just be the avlqc identifier here
		output_path_cur = "avlqc" + "-" + ptID + "-interviewVideoQC_" + interview_type + "-day" + str(join_csv["day"].tolist()[0]) + "to" + str(join_csv["day"].tolist()[-1]) + '.csv'
	...
	output_path_cur = "avlqc" + "-" + ptID + "-interviewVideoQC_" + interview_type + "-day" + str(study_days[0]) + "to" + str(study_days[-1]) + '.csv'
