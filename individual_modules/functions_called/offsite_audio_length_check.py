...
def audio_length_check(data_root, study, length_limit):
	...
	path_to_send = "*/offsite_interview/processed/audio_to_send"
	...
	for filep in send_paths_list:
		...
		try:
			...
			print("Problem with GENERAL processed audio folder for " + ptID + ", continuing")
			continue
		...
		try:
			...
			print("Problem with DPDash CSV for " + ptID + ", continuing")
			continue
		...
		try:
			...
			print(filen + " is missing a record in  the DPDash CSV for " + ptID + ", continuing")
			continue
