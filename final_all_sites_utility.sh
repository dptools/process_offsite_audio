...
# get absolute path to dir script is being run from, to save history of emails in logs
full_path=$(realpath $0)
# TODO - if decide to save this outside of the repo root, will need to change this path
...
python "$repo_root"/individual_modules/functions_called/concat_all_csvs_func.py "$data_root" "$repo_root"/logs/TOTAL/"$cur_date"
