...
# basic path settings
data_root="/mnt/prescient/Prescient_data_sync/PHOENIX"
study="PrescientSG"
export data_root
export study
...
site_email_list="mennis2@partners.org,gurpreet_rekhi@imh.com.sg,mei_san_ang@imh.com.sg,yi_chian_chua@imh.com.sg,amirah_m_iskandar@imh.com.sg"
