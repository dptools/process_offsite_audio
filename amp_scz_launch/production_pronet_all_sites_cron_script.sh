...
bash /opt/software/process_offsite_audio/amp_scz_launch/final_all_sites_utility.sh /mnt/ProNET/Lochness/PHOENIX "HRAHIMIEICHI@partners.org,linying.li@emory.edu,dmohandass@mgh.harvard.edu" PronetProduction
...
if [[ $(date +%u) == 1 ]]; then
	pii_email_list="pwolff@emory.edu,zarina.bilgrami@emory.edu,linying.li@emory.edu,eliebenthal@mclean.harvard.edu,HRAHIMIEICHI@partners.org,dmohandass@mgh.harvard.edu"
	deid_email_list="pwolff@emory.edu,zarina.bilgrami@emory.edu,linying.li@emory.edu,eliebenthal@mclean.harvard.edu,HRAHIMIEICHI@partners.org,jtbaker@partners.org,sylvain.bouix@etsmtl.ca,scott.woods@yale.edu,SRay@northwell.edu,angela.nunez@yale.edu,dmohandass@mgh.harvard.edu"
